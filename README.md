...
## [Fronend URL](http://a0d5dea8ba28d4465841928b59f133e1-1890962381.us-east-1.elb.amazonaws.com/)
## [Backend URL](http://a9b29e3a3e6ed4352bee8d1ae7fe8cc9-443600267.us-east-1.elb.amazonaws.com/movies)
...
In the this folder, you'll find 2 folders, one named `frontend` and one named `backend`, where each application's source code is maintained. Your job is to use the team's [existing documentation](./frontend/Readme.md) and create CI/CD pipelines to meet the teams' needs.
